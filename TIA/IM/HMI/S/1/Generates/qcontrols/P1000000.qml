...
IGuiPage
{
	...
	IGuiAlarmView
	{
		...
		IGuiListCtrl
		{
			...
			IGuiListHeader
			{
				...
				qm_columnWidthList: [22, 57, 81, 74, 154]
				color: "#ff84868c"
	...
	IGuiSliderSwitchHorizontal
	{
		...
		qm_SliderRectOffFillColor: "#ffef0000"
